...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative md:sticky md:top-0 h-auto md:h-screen w-full flex items-start md:items-center overflow-hidden pt-4 pb-20 md:pt-[80px] md:pb-0 mt-[60px] md:mt-0">
